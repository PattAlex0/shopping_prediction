...
- Three variables representing the time (seconds) spend on administrative, informational, and product related pages
...
The code below is an application of example code provided in *Practical Data Science with R*, (pp. 109)
